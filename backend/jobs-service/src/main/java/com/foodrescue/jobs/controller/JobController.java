...
//    public Flux<Job> byOrder(@PathVariable String orderId) {
//        return service.getByOrderId(orderId);
//    }
//
//    @GetMapping("/status/{status}")
//    public Flux<Job> byStatus(@PathVariable String status) {
//        return service.getByStatus(status);
//    }
//
//    @GetMapping("/courier/{courierId}")
//    public Flux<Job> byCourier(@PathVariable String courierId) {
...
//    public Mono<ResponseEntity<ApiResponse<Job>>> updateStatus(@PathVariable String id,
//                                                               @RequestParam String status) {
//        return service.updateStatus(id, status).map(ResponseEntity::ok);
//    }
//
//    @PutMapping("/{jobId}/assign-courier/{courierId}")
//    public Mono<ResponseEntity<ApiResponse<Job>>> assignCourier(@PathVariable String jobId,
