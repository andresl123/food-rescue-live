...
export default function SignupPage() {
  ...
  const renderForm = () => {
    switch (view) {
      ...
      case "resetPassword":
        // Use the new unified, animated ResetPasswordForm
        return <ResetPasswordForm onBack={() => setView("login")} />;
            ...
            {(view === "login" || view === "signup") && (
              <div className="btn-group w-100 mb-3 border border-dark rounded">
                ...
                <label
                  ...
                  htmlFor="signupTab"
                  style={{
                    backgroundColor: view === "signup" ? "#000" : "#fff",
                    color: view === "signup" ? "#fff" : "#000",
                ...
                <label
                  ...
                  htmlFor="loginTab"
                  style={{
                    backgroundColor: view === "login" ? "#000" : "#fff",
                    color: view === "login" ? "#fff" : "#000",
                  }}
                >
                  Login
                </label>
