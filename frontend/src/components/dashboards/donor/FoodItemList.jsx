...
export default function FoodItemsList() {
  ...
  // ✅ Fetch food items when a lot is selected
  useEffect(() => {
  ...
  // ✅ Handle when food item edited
  const handleItemUpdated = () => {
    if (selectedLot) {
      setSelectedItem(null);
      setEditItem(null);
      getFoodItemsByLot(selectedLot).then((res) => {
        if (res.success) setFoodItems(res.data);
      });
    }
  };
  ...
  return (
    <div className="container-fluid px-4 py-4">
      ...
      <div className="d-flex align-items-center mb-4">
        ...
        >
          <i className="bi bi-egg-fried text-white" style={{ fontSize: "1.5rem" }}></i>
        </div>
        <div>
          <h2 className="fw-bold mb-1" style={{ color: "#111827" }}>
            Food Inventory
          </h2>
          <p className="mb-0 text-secondary">Manage and track your food items</p>
        </div>
      </div>

      {/* ---------- LOT SELECT ---------- */}
      <div className="bg-white shadow-sm rounded-4 p-4 mb-4 position-relative">
        <label className="fw-semibold text-secondary mb-2">Select Lot</label>
        <div style={{ position: "relative" }}>
          ...
          >
            ...
            >
              Choose a lot to view food items
            </option>
      ...
      {!selectedLot && (
        <div className="text-center bg-white shadow-sm rounded-4 p-5 text-secondary">
          <i className="bi bi-egg-fried mb-3" style={{ fontSize: "3rem", color: "#a5b4fc" }}></i>
            ...
            >
              ...
              >
                ...
                <div className="d-flex align-items-center gap-3">
                  ...
                  >
                    <i className="bi bi-box" style={{ color: "#6366f1", fontSize: "1.4rem" }}></i>
                  </div>
                  <div>
